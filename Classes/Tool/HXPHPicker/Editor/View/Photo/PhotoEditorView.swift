...
public class PhotoEditorView: UIScrollView, UIGestureRecognizerDelegate {
    ...
    public override var zoomScale: CGFloat {
    ...
    public func reset(_ animated: Bool) {
    ...
    public func cropping(completion: ((PhotoEditResult?) -> Void)?) {
