...
public class EditorImageResizerMaskView: UIView {
    ...
    lazy var frameLayer: CAShapeLayer = {
        let layer = CAShapeLayer()
        layer.strokeColor = corpBorderColor.cgColor
    ...
    init(isMask: Bool, maskType: MaskType = .blackColor, corpBorderColor: UIColor = .white) {
        self.isMask = isMask
        self.maskType = maskType
        self.corpBorderColor = corpBorderColor
