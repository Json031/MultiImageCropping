...
class EditorImageResizerView: UIView {
    ...
    lazy var maskBgView: EditorImageResizerMaskView = {
        let maskBgView = EditorImageResizerMaskView.init(isMask: true, maskType: cropConfig.maskType, corpBorderColor: cropConfig.corpBorderColor)
    ...
    lazy var maskLinesView: EditorImageResizerMaskView = {
        let maskLinesView = EditorImageResizerMaskView.init(isMask: false, corpBorderColor: cropConfig.corpBorderColor)
