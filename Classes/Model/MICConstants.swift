...
let micScreenWidth = UIScreen.main.bounds.size.width
let micScreenHeight = UIScreen.main.bounds.size.height
...
let micNavigationBarHeight = micStatusBar_Height() + 44.0
